		...
		<form method="POST" action="update.php">
			<table>
				...
				<tr>
					...
					<td><input type="text"  value=<?php echo $pc ?> name="f_PCD"></td>
				</tr>
				<tr>
					<th><label>MFG_Date</label></th>
					<td><input type="date" value=<?php echo $md?> name="f_mfd"></td>
				</tr>
				<tr>
					<th><label>Expiry_Date</label></th>
					<td><input type="date" value=<?php echo $ed ?> name="f_ex"></td>
				</tr>
				<tr>
					<th><label>Catagory</label></th>
					<td><input type="text" value=<?php echo $cat ?> name="f_cat"></td>
				</tr>
				<tr>
					<td colspan="2">
